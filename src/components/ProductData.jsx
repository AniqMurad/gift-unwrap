...
const products = {
    giftsForHer: [
        { id: 1, name: "Le Sigh Tee", price: 68, originalPrice: 98, discount: 25, subcategory: "Apparels", image: giftsforherimages },
        { id: 2, name: "Elegant Earrings", price: 45, originalPrice: 60, discount: 25, subcategory: "Accessories", image: giftsforherimages },
        { id: 3, name: "Makeup Kit", price: 80, originalPrice: 100, discount: 20, subcategory: "Personal Care", image: giftsforherimages },
        { id: 4, name: "Perfume Set", price: 60, originalPrice: 85, discount: 30, subcategory: "Personal Care", image: giftsforherimages },
        { id: 5, name: "Handbag", price: 120, originalPrice: 150, discount: 20, subcategory: "Accessories", image: giftsforherimages },
        { id: 6, name: "Customized Necklace", price: 55, originalPrice: 75, discount: 27, subcategory: "Customized Gift", image: giftsforherimages },
    ],
    giftsForHim: [
