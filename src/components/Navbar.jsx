...
//           <input
//             className="rounded-tl-md rounded-bl-md text-[#A0A0A0] w-96 border border-[#E9E9E9] py-2 px-4 focus:outline-none focus:border-black" // Increased width
//             placeholder="What are you looking for today?"
//           />
//           <button className="rounded-tr-md rounded-br-md text-sm font-normal cursor-pointer border border-black bg-black text-white py-2 px-6 hover:bg-gray-800 transition-colors" onClick={handleSeacrh}>
//             SEARCH
//           </button>
//         </div>
//       )}
...
//               <DropdownMenuGroup>
//                 <DropdownMenuItem>
//                   <div className="w-full flex justify-center"> {/* Corrected w-100% to w-full */}
//                     No Items Available
//                   </div>
//                 </DropdownMenuItem>
//               </DropdownMenuGroup>
//               <DropdownMenuItem>
//                 <Button
//                   className="bg-black text-white font-bold w-full" // Added w-full
...
//               </Button>
//               {isCartOpen && (
//                 <div className="absolute right-0 top-full mt-2 w-96 bg-white p-4 border rounded-2xl shadow-2xl z-30"> {/* Increased width and z-index */}
...
//                   ) : (
//                     <div className="space-y-3 max-h-72 overflow-y-auto pr-1"> {/* Increased max-h */}
//                       {cartItems.map((item) => (
//                         <div key={`${item.category}-${item.id}`} className="flex items-center gap-3 border-b pb-3 last:border-b-0">
//                           <img
//                             src={item.image || (item.images && item.images[0])}
//                             alt={item.name}
//                             className="w-16 h-16 object-cover rounded-md" // Slightly larger image
//                           />
//                           <div className="flex-grow">
//                             <p className="text-sm font-medium truncate w-48" title={item.name}>{item.name}</p> {/* Added title for full name on hover */}
...
//                             View Cart & Checkout
//                         </button>
//                         <button className="text-sm text-gray-700 hover:text-black underline" onClick={handleContinueShopping}>
//                             Continue Shopping
//                         </button>
//                         </div>
//                     </div>
