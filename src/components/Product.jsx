    ...
    return (
        <div className={`${containerWidthClass} group mb-6`}>
            <div className='relative bg-[#FBF4E8] rounded-[24px] overflow-hidden'>
                ...
                <button
                    className={`p-1 rounded-full absolute top-[10px] right-[10px] transition-all z-20 ${isInWishlist ? "bg-[#DB4444]" : "bg-white"}`}
            ...
            <div className='mt-4'>
                <Link to={`/product/${category}/${id}`} className="block">
                    <p className="font-medium text-gray-800 group-hover:text-black transition-colors truncate">
                        {product.name}
                    </p>
                </Link>
