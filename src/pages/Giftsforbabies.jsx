...
const Giftsforbabies = () => {
    ...
    const giftsForBabiesProducts = products.filter(product =>
    ...
    return (
        <div>
            ...
            <div className='bg-[#FBF4E8] justify-center gap-2 sm:gap-4 lg:gap-8 flex flex-wrap text-[10px] sm:text-[12px] lg:text-[14px] font-semibold text-[#1F1F1F] uppercase py-4 sm:py-6 px-2'>
                <p className={`cursor-pointer ${selectedCategory === 'newborn' ? 'underline' : ''}`} onClick={() => handleCategorySelect('newborn')}>
            ...
            <div className="px-4 sm:px-8 lg:px-16 py-6 sm:py-8 lg:py-10 flex justify-center"> {/* Changed from justify-between to justify-center */}
                <div className="w-full transition-all duration-300"> {/* Changed width to full */}
                    {/* filters */}
                    ...
                    {giftsForBabiesProducts.length > 0 ? (
                        <div className={`justify-items-center grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-${columns} gap-3 sm:gap-4 lg:gap-6 mt-6 sm:mt-8 lg:mt-10 transition-all duration-300`}>
                            {giftsForBabiesProducts.map((product) => (
                                <Product
                                    key={product.id}
