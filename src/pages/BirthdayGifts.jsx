...
const BirthdayGifts = () => {
  ...
  const handleCategorySelect = (category) => {
    setSelectedCategory(category); // Update the visual selected state

    // Determine the URL based on the selected category
    let url = "";
    switch (category) {
      case "his birthday":
        url = "/Giftforhim";
      ...
      case "employee birthday":
        url = "/Giftforcompanies"; // Changed from original '/Giftforcompanies'
        break;
      case "baby birthday":
        url = "/Giftforbabies";
        break;
      default:
        url = "/"; // Fallback for unknown categories
    }
