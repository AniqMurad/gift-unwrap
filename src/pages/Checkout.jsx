            ...
            <form onSubmit={handleSubmitOrder}>
                <div className="flex flex-col lg:flex-row px-4 sm:px-8 lg:px-16 py-6 sm:py-10 lg:py-20 justify-between gap-6 lg:gap-8">
                    <div className='w-full lg:w-[60%] xl:w-[630px] space-y-5 lg:space-y-6'>
                        ...
                        <button
                            type="submit"
                            className='w-full cursor-pointer bg-black text-white text-sm font-semibold mt-6 px-6 py-3 rounded-lg uppercase hover:bg-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed'
