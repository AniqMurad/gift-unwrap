  ...
  const handleSubmitOrder = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        showNotification(
          "success",
          `Order placed successfully! Order ID: ${data._id}. Redirecting...`
        );
        ...
        <div className="flex flex-col lg:flex-row px-4 sm:px-8 lg:px-16 py-6 sm:py-10 lg:py-20 justify-between gap-6 lg:gap-8">
          <div className="w-full lg:w-[60%] xl:w-[630px] space-y-5 lg:space-y-6">
            <div className="space-y-3 sm:space-y-4">
              <h2 className="text-xl sm:text-2xl lg:text-[30px] font-semibold">
            ...
            <div className="space-y-4 sm:space-y-5">
              ...
              <div className="rounded-lg p-4 sm:p-5 bg-[#F5F5F5] border border-[#E0E0E0] opacity-60">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <label
                    htmlFor="creditCard"
                    className="font-medium text-gray-500 cursor-not-allowed text-sm sm:text-base"
                  >
                    Credit Card
                  </label>
                ...
                <p className="text-xs sm:text-sm text-[#999999] mt-2">
                  Online payment is not available right now. Please use Cash on
                  Delivery.
                </p>
              </div>
              ...
              <div
                className={`rounded-lg p-4 sm:p-5 cursor-pointer ${
                  paymentMethod === "cod"
                    ? "bg-[#F0F5FF] border border-blue-500"
              ...
              >
                ...
                {paymentMethod === "cod" && (
                  <p className="text-xs sm:text-sm text-[#696C70] mt-2">
